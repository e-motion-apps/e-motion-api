...
class ProviderSeeder extends Seeder
{
    public function run(): void
    {
        $providers = [
            ...
            ["name" => BoltDataImporter::getProviderName(), "color" => "#24f0a0", "url" => "https://www.micromobility.com/", "android_url" => "https://play.google.com/store/apps/details?id=com.micromobility.bolt", "ios_url" => "https://apps.apple.com/us/app/bolt-electric-scooters/id1450999639"],
