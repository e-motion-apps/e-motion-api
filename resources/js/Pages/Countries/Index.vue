...
const sortingOptions = [
  { name: __('Sorting.Latest'), href: '/admin/countries?order=latest' },
  { name: __('Sorting.Oldest'), href: '/admin/countries?order=oldest' },
  { name: __('Sorting.byName'), href: '/admin/countries?order=name' },
]
        ...
        <div class="m-4 flex flex-col lg:mx-8">
          ...
          <div class="mb-3 mt-4 flex flex-wrap items-center justify-end md:justify-between">
            ...
            <div class="m-1 flex w-full rounded-md shadow-sm md:w-fit">
              <div class="relative flex grow items-stretch focus-within:z-10">
                ...
                <input v-model.trim="searchInput" type="text" class="block w-full rounded border-0 py-3 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-sm placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blumilk-300 sm:text-sm sm:leading-6 md:py-1.5" :placeholder="__('GUI.searchCountry')">
              </div>
          ...
          <div v-else>
            <p class="mt-6 text-lg font-medium text-gray-500">
              {{ __('Prompt.sorryWeCouldntCountries') }}
            </p>
          </div>
