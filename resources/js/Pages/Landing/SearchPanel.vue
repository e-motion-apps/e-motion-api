...
<template>
    <div class="mx-auto mt-4 flex w-11/12 flex-col sm:mt-12">
        ...
        <div class="mt-2 flex w-full flex-wrap justify-between px-2 lg:px-3 mb-8">
        ...
        >
            <div class="flex w-full justify-between sm:flex-col sm:justify-start">
                ...
                <div class="mt-0 flex w-fit items-center justify-end sm:mt-1 sm:justify-start">
                    <div class="flex rounded-full mt-2 text-gray-600">
                        <InertiaLink :href="'/' + filterStore.selectedCity.country.slug + '/' + filterStore.selectedCity.slug" class="flex px-2 items-center sm:border rounded-full py-0.5 text-gray-600 sm:bg-gray-50 hover:bg-gray-200">
                            <InformationCircleIcon class="h-8 w-8 sm:h-6 sm:w-6" />
                            <p class="hidden sm:flex text-xs font-medium ml-1">{{ __('Check details') }}</p>
                        </InertiaLink>
                    </div>
                </div>
            </div>
                ...
                >
                    <div class="flex w-full justify-between sm:flex-col sm:justify-start">
                        ...
                        <div class="mt-0 flex w-fit items-center justify-end sm:ml-[64px] sm:mt-1 sm:justify-start">
                            ...
                            <InertiaLink :href="'/' + item.country.slug + '/' + item.slug" class="ml-1 flex rounded-full py-0.5 text-gray-600 hover:bg-gray-200">
